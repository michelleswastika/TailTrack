...
struct ReportDetailAdminView: View {
    var body: some View {
        ZStack {
...
//                        isi ciri-ciri
                    ...
                    ButtonDestination(buttonIcon: "checkmark", buttonText: "Valid") {
                        HomeView()
                    }
                    .padding(.top, 30)
                    Spacer()
...
struct ReportDetailAdminView_Previews: PreviewProvider {
